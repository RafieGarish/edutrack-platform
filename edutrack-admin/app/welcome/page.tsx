...
function BlurText({ text, containerVariant, charVariant, charStyle = {} }: { text: string; containerVariant: any; charVariant: any; charStyle?: React.CSSProperties }) {
...
export default function WelcomePage() {
  ...
  useEffect(() => {
    if (phase === PHASES.length - 1) {
      const subtitleTimer = setTimeout(() => setShowSubtitle(true), 2200);
