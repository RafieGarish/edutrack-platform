        ...
        <main className="flex-1 flex items-center justify-center p-6">
          <div className="layout-content-container flex flex-col max-w-[480px] w-full text-center">
            ...
            <div className="flex flex-col gap-2 mb-5">
              <h1 className="text-slate-00 dark:text-slate-100 text-2xl font-extrabold leading-tight tracking-tight">
                Check your email
              </h1>
            ...
            <div className="flex flex-col gap-3 w-full">
              <a
                ...
                className="flex items-center justify-center rounded-xl h-11 px-8 bg-primary text-black text-base font-semibold shadow-lg shadow-primary/20 hover:brightness-110 active:scale-[0.98] transition-all"
              >
