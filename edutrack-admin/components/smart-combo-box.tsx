    ...
    >
      ...
      <div
        className={classNames(
          ...
          "group flex min-h-10 w-full items-center gap-2 rounded-md border bg-background px-2",
      ...
      >
        ...
        <input
          ...
          className={classNames(
            ...
            "peer flex-1 bg-transparent outline-none placeholder:text-muted-foreground text-foreground"
          )}
          value={query}
          onChange={(e) => {
          ...
          >
            ...
            {showCreate && (
              <div
                ...
                className={classNames(
                  "flex cursor-pointer items-center gap-2 px-2 text-foreground",
                  activeIndex === 0
            ...
            {[...groups.entries()].map(([group, items]) => {
              return (
                <div key={group} role="group" aria-label={group}>
                  {group !== "Other" && (
                    <div className="sticky top-0 z-10 bg-popover px-2 py-1 text-[10px] uppercase tracking-wider text-muted-foreground">
                      {group}
                    </div>
                  )}
                  {items.map((opt) => {
